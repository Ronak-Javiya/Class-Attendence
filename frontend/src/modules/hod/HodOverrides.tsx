/**
 * HodOverrides — Override decisions at department level.
 */
...
export default function HodOverrides() {
    ...
    return (
        <div>
            <h1 className="text-2xl font-bold text-surface-900 mb-6">Override Decisions</h1>
            ...
            >
                <div className="flex items-center gap-2 mb-5">
                    ...
                    <h3 className="text-sm font-semibold text-surface-800">HOD Override</h3>
                </div>
